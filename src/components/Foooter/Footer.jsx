...
const Footer = () => {
  ...
  return (
    <>
      <FooterMobilePattern
        src={require("../../images/bg-footer-top-mobile.svg").default}
      />
      <FooterDesktopPattern
        src={require("../../images/bg-footer-top-desktop.svg").default}
      />
      <FooterWrapper>
        <Container>
          <FooterContainer>
            <FooterCol>
              <Fade right>
                <Newsletter>
                  ...
                  <NewsletterDescription>
                    To recieve tips on how to grow your community, sign up to
                    our weekly newsletter. We’ll never send you spam or pass on
                    your email address
                  </NewsletterDescription>
            ...
            <FooterCol>
              <Fade left>
                <Social>
                  ...
                  <SocialInfo>
                    <Icon
                      src={require("../../images/icon-phone.svg").default}
                    />
                    Phone: +1-543-123-4567
                  </SocialInfo>
                  <SocialInfo>
                    <Icon
                      src={require("../../images/icon-email.svg").default}
                    />
                    example@huddle.com
                  </SocialInfo>
